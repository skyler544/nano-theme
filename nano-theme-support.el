...
(defun nano-theme (theme mode)
  ...
  (let ((light     '((background light)))
   ...
   '(show-paren-match              ((t (:inherit (nano-subtle nano-strong)))))
...
;;   '(nano-modeline-inactive             ((t (:inherit nano-subtle))))
   ...
   '(org-level-1                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-2                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-3                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-4                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-5                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-6                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-7                             ((t (:inherit (nano-strong nano-default)))))
   '(org-level-8                             ((t (:inherit (nano-strong nano-default)))))
